...
class GroundedAnswer(BaseModel):
    ...
    answer: Annotated[
        ...
        Field(
            description=(
                "Практический ответ на русском языке, основанный только на "
                "источниках и содержащий ссылки [1], [2]. Без рассуждений, "
                "списка источников и URL. Объем должен соответствовать вопросу: "
                "короткий ответ для простого вопроса или подробные шаги, документы "
                "и условия для процедурного вопроса. Без формального вступления."
            )
        ),
    ]
